    ...
    case 0:
     ...
     case 1:
      ...
      if (digitalRead(sensorPin) == HIGH) {
       ...
       case 2:  
               Serial.println("Estoy en caso2");
               while (INDICE <6){
                Serial.println("Almacenando codigoCaso1");
                almacenar_codigo();
     ...
     case 3:  if (digitalRead(sensorPin) == HIGH){
        // si se genera alarma salta para caso 2
        Serial.println("Generando alarma caso3");
        generar_alarma();
        var =2;
        break;
      }
      else{
        // si sensor no esta en HIGH esperar por que desarmen
               Serial.println("Estoy en caso3");
               while (INDICE <6){
                 //prueba aqui
                 CLAVE_CORRECTA = false;
                if (digitalRead(sensorPin) == HIGH){ // si en lo que se aprieta tecla sensor pasa a HIGH
                   var =2;
                    break;
                  }
                else{
                Serial.println("Almacenando codigoCaso3");
                almacenar_codigo();
                Serial.println("sigo aqui");
                }
               }
