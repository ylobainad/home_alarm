...
char CLAVE_LUZ[7] = "012345";   // almacena en un array la contraseña de encender la luz
...
void almacenar_codigo(){
 ...
 void validar_clave_maestra(){
  ...
  void validar_clave_luz(){
    if(!strcmp(CLAVE, CLAVE_LUZ)){   // compara clave ingresada con clave maestra
      // Serial.println(" Correcta");
       CLAVE_CORRECTA=true;}   // imprime en monitor serial que es correcta la clave
