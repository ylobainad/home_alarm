...
// Date: 30/01/2020 
// Description: Este codigo permite crear un sistema de Deteccion de intrusos, con capacidad de Armado y Desarmado
// desde un teclado matricial intruduciendo un codigo de usuario valido o a traves de un mando a distancia, cuenta con LEDs que notifican al usuario sobre el estado del 
// sistema. Ademas posee un tiempo de retardo en el armado acompanado de una notificacion sonora durante el armado
// del sistema. Al ocurrir una alarma el sistema emitira una alarma sonora continua hasta tanto el sistema sea desarmado. 
...
const int ledPin2 = A3;                // Built-in LED
...
const int relayPin = A4;               // Relay que dispara la sirena
...
void desarmar_alarma() {
  ...
  INDICE = 0;
  Serial.println("estoy DESARMANDO ALARMA");
  ESTADO = true;
}
